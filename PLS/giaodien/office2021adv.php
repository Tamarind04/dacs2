...
<section class="cartegory">
    <div class="container">
        <div class="cartegory-top row">
            <a href="./index.php"><p>Trang chủ</p></a> <span>&#10230;</span> <a href="./advcartegory.php"><p>Khoá học nâng cao</p></a> <span>&#10230;</span>  <a href="./advcartegory.php"><p>Khoá học phổ biến</p></a> <span>&#10230;</span><p style="cursor: pointer">Office 2021</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
                ...
                <ul>
                    <li class="cartegory-left-li">
                        ...
                        <ul>
                            ...
                            <li><a href="./office2016basic">Office 2016</a></li>
            ...
            <div class="cartegory-right row">
                <div class="cartegory-right-top-item">
                    <p>KHÓA HỌC OFFICE 2021 NÂNG CAO</p>
                </div>
                <form method="GET" action="">
                        ...
                        <div class="filter">
                            ...
                            <a style="background: none;" href="office2016adv.php" class="btn btn-danger">Reset</a></button>
                        </div>
                    </form>
                ...
                <?php
                        ...
                        if(isset($_GET['status']) && $_GET['status'] != ''){
                            ...
                            $lietke_sql = "SELECT * FROM khoahoc WHERE loaikhoahoc='$status' AND phanloai = 'Nâng cao' AND nam ='2021' ";
                          } else {
                            $lietke_sql = "SELECT * FROM khoahoc WHERE phanloai = 'Nâng cao' AND nam ='2021'";
                          }
