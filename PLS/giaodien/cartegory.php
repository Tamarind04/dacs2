...
<section class="cartegory">
    <div class="container">
        <div class="cartegory-top row">
            <a href="./index.php"><p>Trang chủ</p></a> <span>&#10230;</span> <p style="cursor: pointer">Khoá học căn bản</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
                ...
                <!-- <div class="cartegory-right-top-item"> -->
                    <form method="GET" action="">
                        ...
                        <div class="filter">
                            ...
                            <a style="background: none;" href="cartegory.php" class="btn btn-danger">Reset</a></button>
                        </div>
                    </form>
                <!-- </div> -->
                <div class="cartegory-right-content row">
                    <?php
                        ...
                        if(isset($_GET['status']) && $_GET['status'] != ''){
                            ...
                            $lietke_sql = "SELECT * FROM khoahoc WHERE loaikhoahoc='$status' AND phanloai = 'Cơ bản' ";
                          } else {
                            $lietke_sql = "SELECT * FROM khoahoc WHERE phanloai = 'Cơ bản'";
                          }
