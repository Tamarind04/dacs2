...
<section class="cartegory">
    <div class="container">
        <div class="cartegory-top row">
            <a href="./index.php"><p>Trang chủ</p></a> <span>&#10230;</span> <p style="cursor: pointer">Khoá học nâng cao</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="cartegory-left">
                <ul>
                    ...
                    <li class="cartegory-left-li">
                        ...
                        <ul>
                            <li><a style="font-size: 14px;"href="#">KHÓA HỌC PHỔ BIẾN</a></li>
            ...
            <div class="cartegory-right row">
                ...
                <form method="GET" action="">
                        ...
                        <div class="filter">
                            ...
                            <a style="background: none;" href="advcartegory.php" class="btn btn-danger">Reset</a></button>
                        </div>
                    </form>
                ...
                <?php
                        ...
                        if(isset($_GET['status']) && $_GET['status'] != ''){
                            ...
                            $lietke_sql = "SELECT * FROM khoahoc WHERE loaikhoahoc='$status' AND phanloai = 'Nâng cao' ";
                          } else {
                            $lietke_sql = "SELECT * FROM khoahoc WHERE phanloai = 'Nâng cao'";
                          }
    ...
    ?>
                ...
                <div class="cartegory-right-bottom-item">
                    ...
                    <!-- <div class="cartegory-right-bottom-item">
                        <p><span>&#171;</span><span>1 2 3 4 5</span><span>&#187;</span>Trang cuối</p>
                    </div> -->
                </div>
            </div>
